  ...
  return (
    <div className="flex items-center gap-4 sm:gap-6 pt-12 flex-wrap sm:flex-nowrap">
      <img
        ...
        className="size-28 sm:size-36 rounded-full ring-1 ring-zinc-300 dark:ring-zinc-700 ring-offset-1 ring-offset-white dark:ring-offset-black select-none"
      />
      ...
      <div className="min-w-0">
        <div className="flex items-center gap-2">
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            className="size-5 sm:size-6 text-info translate-y-px cursor-default"
          >
            <path
              fill="#009CF5"
