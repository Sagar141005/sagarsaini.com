...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        className="overflow-hidden bg-popover p-0 shadow-2xl border border-border w-[calc(100%-2rem)] max-w-lg sm:max-w-xl"
      ...
      >
        <Command
          className={cn(
            ...
            "[&_[cmdk-item]_svg]:h-4 [&_[cmdk-item]_svg]:w-4 **:[[cmdk-item]]:px-2 **:[[cmdk-item]]:py-2"
          )}
        >
          {children}
        </Command>
  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "flex h-10 w-full rounded-lg bg-transparent py-2 text-base font-light outline-none placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
          className
        )}
        {...props}
      />
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        ...
        "**:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:py-2 **:[[cmdk-group-heading]]:text-xs **:[[cmdk-group-heading]]:font-light **:[[cmdk-group-heading]]:text-muted-foreground",
        className
      )}
      {...props}
    />
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "relative flex cursor-pointer items-center gap-2 rounded-lg px-2 py-2 text-sm font-light outline-none select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 data-[selected=true]:bg-accent data-[selected=true]:text-accent-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class^='text-'])]:text-muted-foreground",
        className
      )}
      {...props}
    />
